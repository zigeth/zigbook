...
This page syncs automatically from Zig's source: `std/coff.md`.
::
...
| `REGISTER_PARAM` | A register parameter. |
...
| `secrel` | The 32-bit offset of the target from the beginning of its section. This is used to support debugging information and static thread local storage. |
| `low12a` | Bit 0:11 of section offset of the target for instructions ADD/ADDS (immediate) with zero shift. |
...
### <a id="const-image-nt-optional-hdr64-magic"></a>`IMAGE_NT_OPTIONAL_HDR64_MAGIC`
...
### <a id="const-image-numberof-directory-entries"></a>`IMAGE_NUMBEROF_DIRECTORY_ENTRIES`
...
### <a id="error-cofferror"></a>`CoffError`
...
- `error.InvalidPEMagic`
- `error.InvalidPEHeader`
- `error.InvalidMachine`
- `error.MissingPEHeader`
- `error.MissingCoffSection`
- `error.MissingStringTable`
